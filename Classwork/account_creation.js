...
createAccountButton.addEventListener("click",function() {
    ...
    try {
        ...
        if(userNameInput.value.charCodeAt(0) < asciiStartCapLetter || userNameInput.value.charAt(0) > asciiCapEndLetter) {
            throw "Username must start with a letter.";      
        }
        if(userNameInput.value.charCodeAt(0) < asciiLowerStartCharacter || userNameInput.value.charCodeAt(0)>asciiLowerEndLetter) {
                throw "Username must start with a letter.";
            }
